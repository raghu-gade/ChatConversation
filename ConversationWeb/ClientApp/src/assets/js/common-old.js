$(document).ready(function () {
  ...
  $('.vm-header .vm-search-icon').on('click', function () {
    ...
    $(".vm-search-close").css("left", position.left - 78);
  ...
  $(".vm-add-contact-icon").click(function () {
    ...
    $(".vm-add-contact-icon").slideToggle();
